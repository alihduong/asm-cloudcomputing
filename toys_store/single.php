            ...
            <div class="container">
                <div class="inner-sec-shop pt-lg-4 pt-3">
                    <div class="row">
                        ...
                        $query = "SELECT * FROM tblproduct WHERE pd_id='$id'";
                        ...
                        <div class="col-lg-4 single-right-left ">
                            <div class="grid images_3_of_2">
                                <div class="flexslider1">
                                    ...
                                    <ul class="slides">
                                        <li data-thumb="images/gmt1.jpg">
                                            <div class="thumb-image"> <img src="images/gmt1.jpg" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                                        </li>
                                        <li data-thumb="<?=$row[5]?>">
                                            <div class="thumb-image"> <img src="<?=$row[5]?>" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                                        </li>
                                        <li data-thumb="images/gmt2.jpg">
                                            <div class="thumb-image"> <img src="images/gmt2.jpg" data-imagezoom="true" class="img-fluid" alt=" "> </div>
                                        </li>
                                    </ul>
                            ...
                            <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                                <h3><?= $row[1] ?></h3>
                                <p>$<span class="item_price"><?= $row[2] - 10 ?></span>
                                    <del>$<?= $row[2] ?></del>
                                </p>
                                <div class="rating1">
                                    <ul class="stars">
                                ...
                                <div class="color-quality">
                                    <div class="color-quality-right">
                                        ...
                                        <select id="country1" onchange="change_country(this.value)" class="frm-field required sect">
                                            ...
                                            <option value="null">8 Qty</option>
                                            <option value="null">9 Qty</option>
