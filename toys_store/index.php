                ...
                <div class="row">
                    <div class="col-md-3 top-info text-left mt-lg-4">
                        ...
                        <ul>
                            ...
                            <li class="number-phone mt-3">0327476996</li>
                        </ul>
                    </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light top-header mb-2">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav nav-mega mx-auto">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="AddProduct.php">Manager</a>
                            </li>
            ...
            <div class="container-fluid">
                <div class="inner-sec-shop px-lg-4 px-3">
                    ...
                    <div class="row">
                        ...
                        $query = "SELECT*FROM tblproduct Where pd_id";
                                ...
                                <div class="product-googles-info googles">
                                    <div class="men-pro-item">
                                        <div class="men-thumb-item">
                                            <img src="<?= $row[5] ?>"  class="img-fluid canchinh" alt="">
                                            <div class="men-cart-pro">
                                                <div class="inner-men-cart-pro">
                                                    <a href="single.php?id=<?= $row[0] ?>" class="link-product-add-cart">Quick View</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="info-product-price">
                                                <div class="grid_meta">
                                                    <div class="product_price">
                                                        <h4>
                                                            <a href="single.php?id=<?= $row[0] ?>"><?= $row[1] ?></a>
                                                        </h4>
                                        ...
                                        <div class="item-info-product">
                                            ...
                                            <div class="info-product-price">
                                                <div class="grid_meta">
                                                    <div class="product_price">
                                                        <h4>
                                                            <a href="single.php">Captain America</a>
                                                        </h4>
                                                        <div class="grid-price mt-2">
                                        ...
                                        <div class="item-info-product">
                                            ...
                                            <div class="info-product-price">
                                                <div class="grid_meta">
                                                    <div class="product_price">
                                                        <h4>
                                                            <a href="single.php">Black Panther </a>
                                                        </h4>
                                                        <div class="grid-price mt-2">
                                        ...
                                        <div class="item-info-product">
                                            ...
                                            <div class="info-product-price">
                                                <div class="grid_meta">
                                                    <div class="product_price">
                                                        <h4>
                                                            <a href="single.html">SpiderMan</a>
                                                        </h4>
                                                        <div class="grid-price mt-2">
                ...
                <div class="row footer-top-w3layouts">
                    ...
                    <div class="col-lg-3 footer-grid-w3ls">
                        ...
                        <div class="contact-info">
                            ...
                            <div class="phone">
                                <h4>Contact :</h4>
                                <p>Phone : +121 098 9696 6969</p>
                                <p>Email :
                                    <a href="mailto:nguyenhoangduong0711@gmail.com">nguyenhoangduong0711@gmail.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
